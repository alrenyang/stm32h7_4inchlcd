...
#define LCD_MODEL_4_3_480x272       1
...
#define      HW_I2C_CH_EEPROM       _DEF_I2C1 //M24C64 EEPROM
#define      HW_I2C_CH_TOUCH        _DEF_I2C2 //Touch IC
...
#define      HW_EEPROM_ADDR_TOUCH_4_3           0
#define      HW_EEPROM_ADDR_TOUCH_7_0           50
...
#define _USE_CLI_HW_LTDC            0
#define _USE_CLI_HW_USB             0
#define _USE_CLI_HW_TOUCH           0
#define _USE_CLI_HW_LCD             0
#define _USE_CLI_HW_PWM             0
#define _USE_CLI_HW_INFO            0
#define _USE_CLI_HW_SDRAM           0
