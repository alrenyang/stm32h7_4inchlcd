...
const gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
    {
        ...
        {GPIOF, GPIO_PIN_6,   _DEF_OUTPUT, GPIO_PIN_SET, GPIO_PIN_RESET,   _DEF_HIGH, "LCD_RST"     },      // 6. LCD_RST
        {GPIOC, GPIO_PIN_13,  _DEF_OUTPUT, GPIO_PIN_SET, GPIO_PIN_RESET,   _DEF_HIGH, "LCD_SPI_CS"  },      // 7. LCD_SPI_CS
    };
