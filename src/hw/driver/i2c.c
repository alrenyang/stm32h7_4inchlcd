...
//i2c define i2c bus / gpio bus/ SCL / gpio bus /SDA
static i2c_tbl_t i2c_tbl[I2C_MAX_CH] =
    {
        { I2C4, &hi2c4, GPIOD, GPIO_PIN_12, GPIOD, GPIO_PIN_13},  //M24C64 EEPROM
        { I2C1, &hi2c1, GPIOB, GPIO_PIN_6,  GPIOB, GPIO_PIN_7},   //Touch iC
    };
